...
import com.lijs.nex.core.model.request.UserLoginRequest;
import com.lijs.nex.core.model.vo.UserVO;
import com.lijs.nex.user.model.pager.UserPage;
import com.lijs.nex.user.model.request.UserAddRequest;
import com.lijs.nex.user.model.request.UserRegisterRequest;
import com.lijs.nex.user.model.request.UserUpdateRequest;
import com.lijs.nex.user.service.UserService;
...
public class UserController extends BaseController implements UserApiClient {
    ...
    public BaseResponse<Page<UserDO>> recommendUsers(long pageSize, long pageNum, HttpServletRequest request) {
        UserDO loginUser = userService.getCurrentUser(request);
        String redisKey = String.format("nex:user:recommend:%s", loginUser.getId());
