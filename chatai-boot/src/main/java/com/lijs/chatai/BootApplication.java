...
//@ComponentScan(basePackages = {"com.lijs", "com.lijs.chatai", "com.lijs.chatai.auth"})
@ComponentScan(basePackages = {"com.lijs.chatai", "com.lijs.chatai.user", "com.lijs.chatai.auth"})
