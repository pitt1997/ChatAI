...
import com.lijs.chatai.common.cache.service.RedisCacheService;
import com.lijs.chatai.common.base.constant.CommonConstants;
import com.lijs.chatai.common.base.token.JwtTokenProvider;
import com.lijs.chatai.common.base.utils.TokenUtils;
import com.lijs.chatai.common.base.request.RequestContext;
import com.lijs.chatai.common.base.token.TokenHolder;
...
public class SecurityInterceptor implements HandlerInterceptor {
    ...
    public SecurityInterceptor(DataSourceRouting dataSourceRouting, String... anonUrls) {
        ...
        this.anonUrls.add("/api/ai/chat/stream");
        this.anonUrls.add("/api/ai/chat/websocket");
        this.anonUrls.add("/admin/user/getUserByName");
        this.anonUrls.add("/auth/login");
        this.anonUrls.add("/logout");
    }
