package com.lijs.fizz.user.controller;
...
import com.lijs.fizz.user.model.pager.UserPage;
import com.lijs.fizz.user.model.request.UserAddRequest;
import com.lijs.fizz.user.model.request.UserRegisterRequest;
...
public class UserController extends BaseController implements UserApiClient {
    ...
    public BaseResponse<Page<UserDO>> recommendUsers(long pageSize, long pageNum, HttpServletRequest request) {
        UserDO loginUser = userService.getCurrentUser(request);
        String redisKey = String.format("fizz:user:recommend:%s", loginUser.getId());
