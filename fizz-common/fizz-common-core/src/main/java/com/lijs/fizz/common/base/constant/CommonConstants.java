package com.lijs.fizz.common.base.constant;
...
public class CommonConstants {
    ...
    public interface Service {
         ...
         * 认证服务
         */
        String GATEWAY_SERVICE = "fizz-gateway";

        /**
         * 认证服务
         */
        String AUTH_SERVICE = "fizz-auth";

        /**
         * 管理服务
         */
        String ADMIN_SERVICE = "fizz-admin";

        /**
         * 管理-用户服务
         */
        String USER_SERVICE = "fizz-user";

        /**
         * 管理-用户服务
         */
        String ROLE_SERVICE = "fizz-role-permission";

        /**
         * 管理-资源服务
         */
        String RESOURCE_SERVICE = "fizz-resource";
